...
const SpotifyLoginButton = ({ className, variant = 'default' }: SpotifyLoginButtonProps) => {
  ...
  return (
    ...
    >
      ...
      Connect Spotify
      <LogIn className="w-4 h-4 ml-2 opacity-50 group-hover:opacity-100 transition-opacity" />
    </Button>
  );
};
